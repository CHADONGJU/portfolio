...
const buyLotDraftSummary = useMemo(() => {
  ...
  // 목표 포트폴리오(비중 편집·리밸런싱 안내·도넛 차트)는 통째로 훅에 있다.
  const {
    targetViewMode, setTargetViewMode,
    setSelectedTargetCategory, setSelectedTargetGroup,
    targetCategoryDraft, setTargetCategoryDraft,
    targetBudgetKRW, targetCategoryTotalPercent, targetPortfolioGuide,
    selectedTargetGuide, selectedTargetGroupGuide,
    targetGoalChartData, targetCurrentChartData,
    targetDrilldownChartData, targetCurrentDrilldownChartData,
