...
//
// 저장 키는 반드시 계정별로 분리한다(getScopedStorageKey). 한 기기에서 여러
// 계정으로 로그인해도 서로의 포트폴리오가 섞이지 않아야 한다.
//
// 사파리 시크릿 창처럼 저장이 통째로 막힌 환경에서도 앱이 죽지 않도록 모든
// 접근을 try/catch로 감싸고, 실패는 핸들러로 알린다.
