// 매매 비용: 증권사 수수료와 국내 증권거래세.
//
// 수수료의 원본은 '요율'이 아니라 '금액'이다. 유관기관제비용은 체결된 시장·세션에
// 따라 건마다 달라져서, 요율로 다시 계산하면 증권사 화면과 원 단위로 어긋난다.
// 증권사 화면에 찍힌 금액을 그대로 받는 경로를 항상 우선한다.
//
// 증권거래세는 매도 체결일 기준 세율표를 따르며, 국내 상장 ETF·ETN은 면제다.
